...
//model--> wzorzec java beans- prywatne zmienne a publiczne metody
public class Course {
    private int id;
    ...
    //lista kursantow----------------------------------------------
    private List<Participant> course_participans = new ArrayList<>();


    public List<Participant> getCourse_participans() {
        return course_participans;
    }
    public void addParticipant (Participant p){
        course_participans.add(p);
    }

    public void deleteParticipant(Participant p){
        course_participans.remove(p);
    }
    public int getNoParticipants(){
        return course_participans.size();
    }
    //-------------------------------------------------------------
